...
namespace PiEAPI
{
    public class StudentCode
    {
        ...
        private const int driveType = 0; //flag used to determine what kind of drive style
        /*
         * 0 => tank drive
         * 1 => arcade style
         * 
        ...
        /// </summary>
            public void UserControlledCode()
            {
               // Debug.Print("User Controlled");
                 ...
                 *  robot.UIAnalogVals[0] => x values of left joystick
                 *  robot.UIAnalogVals[1] => y values of left joystick
                 *  robot.UIAnalogVals[2] => x values of right joystick
                 *  robot.UIAnalogVals[3] => y values of right joystick
                 * 
                */

                float[] driveVals = new float[2];
                driveVals = d.getMotorVals(robot.UIAnalogVals[0], robot.UIAnalogVals[1]);
                smcL.motorSpeed = driveVals[0];
                smcR.motorSpeed = driveVals[1];
