...
namespace PiEAPI
{
    ...
    public class AnalogSharpDistanceTracker: AnalogSensor
    {
        ...
        public AnalogSharpDistanceTracker(int pin, int sensor_type)
        {
        ...
        public AnalogSharpDistanceTracker(int pin)
        {
            sharp = GetAnalogPort(pin);
            sharp.SetLinearScale(0, 255);
