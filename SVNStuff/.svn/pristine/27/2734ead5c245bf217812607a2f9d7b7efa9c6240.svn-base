...
namespace PiEAPI
{
    ...
    public class Radio_Series1
    {
        ...
        public void Poll()
        {
            //Debug.Print("is polling");
            int availableBytes;
            robot.yellowLED.Write(false);
            if (port.BytesToRead > 0)
            {
                //Debug.Print("more than 0 bytes to readw");
                ...
                if (availableBytes > 0)
                {
                    //Debug.Print("more than 0 available bytes");
                    // And if full packet was received
                    if (receiver.Fill(buffer, availableBytes))
                    {
                        //Debug.Print("if packet was received");
                        ...
                        {
                            //Debug.Print("attempt to copy packet");
                            ...
                            lock (radioLock)
                            {
                                ...
                                //Debug.Print("UI AnalogVals: " + analogVals);
