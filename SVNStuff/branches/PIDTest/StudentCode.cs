    ...
    public class StudentCode
    {
        ...
        public void UserControlledCode()
        {
           // Debug.Print("User Controlled");
            ...
            robot.radio.telemetry.analog[0] = (byte)sensor1.Read();
            robot.radio.telemetry.analog[1] = (byte)sensor2.Read();
            robot.radio.telemetry.analog[2] = (byte)sensor3.Read();
            robot.radio.telemetry.analog[3] = (byte)sensor4.Read();
            ...
            //smcR.motorSpeed =coeffR*((float)(robot.UIAnalogVals[3] - 128) * 100 / (float)128);
                ...
                i2c2.motorSpeed = -1*((float)(robot.UIAnalogVals[3] - 128) * 100 / (float)128);
           /**///rfR1 = rfR2;
            //rfR2 = tempR;
            //rfL1 = rfL2;
            //rfL2 = tempL;/**/
